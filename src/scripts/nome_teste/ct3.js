 ...
 *
 * Documentacao Caso de teste 3
 * Valida a compra de um pacote com três créditos
 */
export default function (hash) {
  ...
  check(response, {
    'CT3: Código de resposta da criação do pagamento é 201': (response) => response.status === 201,
    'CT3: Verificação do identificador externo do pagamento': (response) => response.json('externalIdentifier') !== undefined,
  });
