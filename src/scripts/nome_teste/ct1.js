 ...
 *
 * Caso de teste 1
 * Valida a compra de um pacote com um crédito
 */
export default function (hash) {
  ...
  check(response, {
    'CT1: Código de resposta da criação do pagamento é 201': (response) => response.status === 201,
    'CT1: Verificação do identificador externo do pagamento': (response) => response.json('externalIdentifier') !== undefined,
  });
